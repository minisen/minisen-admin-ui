    ...
    <span class="toolbar">
      <el-menu class="el-menu-demo" :background-color="themeColor" :text-color="themeColor" :active-text-color="themeColor" mode="horizontal">
        ...
        <el-menu-item index="3" v-popover:popover-message>
          消息通知
          <el-badge :value="noReadMessages.length" :max="99" class="badge" type="success">
            <li style="color:#fff;" class="fa fa-envelope-o fa-lg"></li>
          </el-badge>
          <el-popover ref="popover-message" placement="bottom-end" trigger="click">
            <message-panel :data="{noReadMessages:noReadMessages, haveReadMessages:haveReadMessages}"></message-panel>
          </el-popover>
        </el-menu-item>
